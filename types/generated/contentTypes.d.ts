...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    utm_campaign: Schema.Attribute.Enumeration<
      ['marketing', 'product', 'engineering']
    >;
    utm_source: Schema.Attribute.Enumeration<
      ['newsletter', 'blog', 'external']
    >;
    utmLink: Schema.Attribute.String;
  };
}
...
export interface ApiLogLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    action: Schema.Attribute.Enumeration<['create', 'update']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.String;
